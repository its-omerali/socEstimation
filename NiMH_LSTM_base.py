...
output_stats_folder = os.path.join('basic_model_stats', 'untuned', 'NiMH')
...
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.title('Training vs. Validation Loss - NiMH')
plt.legend()
plt.tight_layout()
loss_plot_path = os.path.join(output_stats_folder, 'loss_plot.png')
plt.savefig(loss_plot_path, bbox_inches='tight')
plt.close()
print(f"Saved NiMH loss plot at: {loss_plot_path}")
...
print(f"Saved NiMH validation metrics at: {metrics_csv_path}")
